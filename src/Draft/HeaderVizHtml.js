...
const blueColour = "#0D7583"


const opacityLow = 0.45;
      ...
      <svg width="691" height="685">
        ...
        */}
        ...
        <g transform={`scale(${0.0006*windowWidth})`}>  
          ...
          <path className="card-bg" filter="url(#static-noise)" fill={blueColour}  fill-opacity={opacityLow} d="M531.539 192.411L623.087 395.298L438.961 503.591L275.889 296.366L531.539 192.411Z"/>
          <path className="card-bg" filter="url(#static-noise)" fill={blueColour}  fill-opacity={opacityLow} d="M279.277 453.039L213.451 288.121L402.972 135.38L537.285 284.5L279.277 453.039Z"/>
          <rect className="card-bg" fill={blueColour} fill-opacity={opacityLow} width="412.224" height="337.291" transform="matrix(0.388631 -0.921394 0.926701 0.375798 127.2 419.359)"/>
          <path className="card-bg" fill={blueColour}  fill-opacity={opacityLow} d="M291.143 109.384L533.855 345.363L391.488 500.329L197.034 535.918L52.7508 319.903L291.143 109.384Z"/>

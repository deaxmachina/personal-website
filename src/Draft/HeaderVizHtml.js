  ...
  return (
    ...
    <div id="header-viz-container">
      <svg width="600" height="600">
        ...
        <g transform={`1`}>  
          <path className="card" fill={darkColour} fill="url(#radial-gradient)" fill-opacity="0.8" d={cardPath1} />
          <path className="card" fill={purpleColour} filter="url(#glow)" fill-opacity={opacityHigh} d={cardPath2} />
          <path className="card" fill={blueColour} fill-opacity={opacityLow} d={cardPath3}/>
          <path className="card" fill={blueColour} fill-opacity={opacityLow} filter="url(#static-noise)" d={cardPath4} />
          <path className="card" fill={blueColour} fill-opacity={opacityLow} filter="url(#static-noise)" d={cardPath5} />
          <rect className="card" fill={blueColour} fill-opacity={opacityLow} width={card6.width} height={card6.height} transform={card6.transform}/>
          <path className="card" fill={blueColour} fill-opacity={opacityLow} d={cardPath7} />
